    ...
    return (
      <div className={`inline-flex items-center gap-2.5 ${className}`}>
        {!imgError ? (
          ...
          <div className="flex items-center gap-2 bg-amber-100 text-amber-900 px-3 py-1 rounded-full font-bold text-sm tracking-wide border border-amber-300">
